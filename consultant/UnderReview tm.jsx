    ...
    return (
        <div className="popup-overlay" onClick={onClose}>
            <div className="popup-card" onClick={(e) => e.stopPropagation()}>
                ...
                {/* Save Button for Checklist and Notes */}
                <button 
                ...
                <div className="preview-section">
                    <h4><i className="bi bi-image me-2" aria-hidden="true"></i>Trademark Representation</h4>
                    {project.design_image_path ? (
                        ...
                        <p className="no-data">No trademark representation submitted.</p>
                    )}
                </div>
...
const UnderReviewtm = () => {
    ...
    const fetchSubmissions = async () => {
        try {
            ...
            const response = await axios.get(`${API_BASE_URL}/api/tm-submissions-under-review`);
            console.log('✅ Fetched Under Review TM submissions:', response.data);
    ...
    // Handler for saving checklist status only (calls the new tm-checklist-update endpoint)
    const handleChecklistUpdate = async (projectId, checklistData) => {
        try {
            const response = await axios.put(`${API_BASE_URL}/api/tm-checklist-update/${projectId}`, checklistData);
    ...
    // Modified handler for final decision (calls the tm-review-action endpoint)
    const handleFinalAction = async (projectId, action, rejection_reason) => {
        ...
        try {
            ...
            await axios.put(`${API_BASE_URL}/api/tm-review-action/${projectId}`, { action, rejection_reason });
        ...
        <div className="Table-container">
            <h2>
                <i className="bi bi-hourglass-split me-2" aria-hidden="true"></i>
                 Under Review - Trademark Submissions
            </h2>
