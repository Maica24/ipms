...
const Rejectedcr = () => {
    ...
    const fetchSubmissions = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/cr-submissions-rejected`);
            console.log('✅ Fetched Rejected cr submissions:', response.data);
