...
const Rejectedum = () => {
    ...
    const fetchSubmissions = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/um-submissions-rejected`);
            console.log('✅ Fetched Rejected um submissions:', response.data);
