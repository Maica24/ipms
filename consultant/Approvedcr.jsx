...
const Approvedcr = () => {
    ...
    const fetchSubmissions = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/cr-submissions-approved`);
            console.log('✅ Fetched Approved CR submissions:', response.data);
