        ...
        <div className="popup-overlay" onClick={onClose}>
            <div className="popup-card" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="preview-section">
                    <h4><i className="bi bi-image me-2" aria-hidden="true"></i>Copyright Work/File</h4>
                    {project.design_image_path ? (
                        ...
                        <p className="no-data">No work/file submitted.</p>
                    )}
                </div>
...
const UnderReviewcr = () => {
    ...
    const fetchSubmissions = async () => {
        try {
            ...
            const response = await axios.get(`${API_BASE_URL}/api/cr-submissions-under-review`);
            console.log('✅ Fetched Under Review CR submissions:', response.data);
    ...
    // Handler for saving checklist status only (calls the new cr-checklist-update endpoint)
    const handleChecklistUpdate = async (projectId, checklistData) => {
        try {
            const response = await axios.put(`${API_BASE_URL}/api/cr-checklist-update/${projectId}`, checklistData);
    ...
    // Modified handler for final decision (calls the cr-review-action endpoint)
    const handleFinalAction = async (projectId, action, rejection_reason) => {
        ...
        try {
            ...
            await axios.put(`${API_BASE_URL}/api/cr-review-action/${projectId}`, { action, rejection_reason });
        ...
        <div className="Table-container">
            <h2>
                <i className="bi bi-hourglass-split me-2" aria-hidden="true"></i>
                 Under Review - Copyright Submissions
            </h2>
