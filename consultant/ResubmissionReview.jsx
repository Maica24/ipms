                ...
                <div className="files-grid">
                  {selectedResubmission.updated_contact_document_path && (
                    <div className="file-card">
                      ...
                      <button 
                        ...
                        onClick={() => window.open(`http://localhost:3006/uploads/${selectedResubmission.updated_contact_document_path}`, '_blank')}
                      >
                  ...
                  {selectedResubmission.updated_design_image_path && (
                    <div className="file-card">
                      ...
                      <button 
                        className="view-file-btn"
                        onClick={() => window.open(`http://localhost:3006/uploads/${selectedResubmission.updated_design_image_path}`, '_blank')}
                      >
                        <i className="fas fa-eye me-1"></i>
                        View
                      </button>
                  ...
                  {selectedResubmission.updated_official_form_path && (
                    <div className="file-card">
                      ...
                      <button 
                        className="view-file-btn"
                        onClick={() => window.open(`http://localhost:3006/uploads/${selectedResubmission.updated_official_form_path}`, '_blank')}
                      >
                        <i className="fas fa-eye me-1"></i>
                        View
                      </button>
