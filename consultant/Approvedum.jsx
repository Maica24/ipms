...
const Approvedum = () => {
    ...
    const fetchSubmissions = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/um-submissions-approved`);
            console.log('✅ Fetched Approved UM submissions:', response.data);
